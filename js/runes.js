...
const presents = [
    ...
    },
    {
        value: 4,
        name: "Лампа",
        description: "Специально на аккумуляторе, чтобы было удобно использовать в общаге, будет удобно сидеть читать!!",
        picture: "lamp",
        cake: "белый",
        runes: [10, 11, 12],
        rightRune: 3
    },
    {
        value: 5,
        name: "Шарф",
        description: "Такой вот шарфик, цвет мне кажется очень-очень тебе подходит, а еще он будет очень круто смотреться с пальто! И пусть даже скоро в пальто будет прохладно, в с шубой этот шарф будет не менее крутым!",
        picture: "scarf",
        cake: "оранжевый",
        runes: [13, 14, 15],
        rightRune: 1
